...
RSpec.describe WishlistsController, type: :controller do
  ...
  describe 'GET #show' do
    it 'returns a success response' do
      ...
      get :show, params: { id: wishlist.to_param }, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe 'GET #edit' do
    it 'returns a success response' do
      wishlist = Wishlist.create! valid_attributes
      get :edit, params: { id: wishlist.to_param }, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Wishlist' do
        expect do
          post :create, params: { wishlist: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: { wishlist: invalid_attributes }, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested wishlist' do
        wishlist = Wishlist.create! valid_attributes
        put :update, params: { id: wishlist.to_param, wishlist: new_attributes }, session: valid_session
        wishlist.reload
      ...
      it 'redirects to the wishlist' do
        wishlist = Wishlist.create! valid_attributes
        put :update, params: { id: wishlist.to_param, wishlist: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'edit' template)" do
        wishlist = Wishlist.create! valid_attributes
        put :update, params: { id: wishlist.to_param, wishlist: invalid_attributes }, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested wishlist' do
      wishlist = Wishlist.create! valid_attributes
      expect do
        delete :destroy, params: { id: wishlist.to_param }, session: valid_session
      end.to change(Wishlist, :count).by(-1)
    end
